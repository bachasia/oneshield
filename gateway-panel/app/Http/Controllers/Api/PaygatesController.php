...
class PaygatesController extends Controller
{
    ...
    public function getSite(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'extra_params.capture_method'               => 'nullable|string|max:20',
            'extra_params.enable_wallets'               => 'nullable|string|max:1',
            'extra_params.statement_descriptor'         => 'nullable|string|max:22',
            'extra_params.description_format'           => 'nullable|string|max:255',
            'extra_params.invoice_prefix'               => 'nullable|string|max:50',
            'extra_params.overwrite_product_title'      => 'nullable|string|max:30',
            'extra_params.user_define_title'            => 'nullable|string|max:255',
            'extra_params.random_title_list'            => 'nullable|string|max:5000',
            'extra_params.product_name'                 => 'nullable|string|max:500',
            'meta'                        => 'nullable|array',
