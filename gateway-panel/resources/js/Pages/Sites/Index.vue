<template>
  <AppLayout title="Payment Sites">
    <div class="flex items-center justify-between mb-6">
      <div class="flex gap-3">
        <select
          v-model="filterGroup"
          @change="applyFilters"
          class="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
    ...
    <div class="bg-white rounded-2xl border border-gray-200">
        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr v-for="site in sites.data" :key="site.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4">
                <button @click="editSite(site)" class="text-indigo-600 hover:text-indigo-700 text-xs font-medium mr-3">Settings</button>
                <button @click="confirmDelete(site)" class="text-red-500 hover:text-red-700 text-xs font-medium">Delete</button>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <!-- Pagination -->
      <div v-if="sites.last_page > 1" class="px-6 py-4 border-t border-gray-200 flex gap-2">
        <Link
    ...
    <!-- Add/Edit Site Modal -->
    <div v-if="showAddModal || editingSite" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6">
        ...
        <form @submit.prevent="submitSite" class="space-y-4">
          ...
          <div>
            ...
            <select v-model="siteForm.group_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 bg-white">
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="text-sm font-medium text-gray-700 mb-3">PayPal</h4>
            <div class="space-y-2">
              ...
              <select v-model="siteForm.paypal_mode" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
          ...
          <!-- Stripe -->
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="text-sm font-medium text-gray-700 mb-3">Stripe</h4>
            <div class="space-y-2">
              ...
              <select v-model="siteForm.stripe_mode" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
...
const siteForm = useForm({
  ...
  stripe_public_key: '', stripe_secret_key: '', stripe_mode: 'test',
});
