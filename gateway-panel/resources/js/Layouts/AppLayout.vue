  ...
  <div class="h-screen bg-gray-50 flex overflow-hidden">
    ...
    <aside class="w-60 bg-white border-r border-gray-200 flex flex-col shrink-0 h-full overflow-y-auto">
      ...
      <div class="h-16 flex items-center gap-2.5 px-5 border-b border-gray-200">
        ...
        <div>
          <span class="text-base font-bold text-gray-900 leading-none">OneShieldX</span>
      ...
      <nav class="flex-1 px-3 py-4 space-y-0.5">
        ...
        <Link
          ...
          :key="item.name"
          :href="item.href"
          class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all group cursor-pointer"
        ...
        <div class="flex items-start gap-2">
          ...
          <div class="min-w-0 flex-1">
            ...
            <Link
              ...
              method="delete"
              as="button"
              class="mt-2 inline-flex items-center text-[11px] font-semibold text-amber-700 hover:text-amber-900 transition-colors cursor-pointer"
            >
              Stop impersonating
            </Link>
          </div>
      ...
      <div class="mx-3 mb-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
        ...
        <div class="flex items-center gap-1.5">
          ...
          <button @click="showToken = !showToken" class="text-gray-400 hover:text-indigo-500 transition-colors p-0.5 cursor-pointer">
          ...
          <button @click="copyToken" class="text-gray-400 hover:text-indigo-500 transition-colors p-0.5 cursor-pointer">
    ...
    <div class="flex-1 flex flex-col min-w-0">
      ...
      <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0">
        ...
        <div class="flex items-center gap-2 text-sm">
          <span class="text-gray-400">OneShieldX</span>
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="https://github.com/bachasia/oneshield" target="_blank" class="text-gray-400 hover:text-gray-600 transition-colors cursor-pointer" title="Documentation">
...
const icons = {
  ...
  blacklist: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>`,
...
const navigation = [
  ...
  { name: 'Blacklist',     href: '/blacklist',    icon: icons.blacklist },
